...
public class CSVHandler {
    ...
    */
    ...
    {
        File file = new File("src/l4Hotels.csv");
    ...
    */
    ...
    {
        File file = new File("src/res.csv");
    ...
    */
    ...
    {
        File file = new File("src/checkin.csv");
        Scanner count = new Scanner(file);
        String currentLine;
        String c;
        int j = 0;
    ...
    */
    ...
    {
        File file = new File("src/checkout.csv");
        Scanner count = new Scanner(file);
        String currentLine;
        String c;
        int j = 0;
    ...
    */
    ...
    {
        File file = new File("src/cancellations.csv");
        Scanner count = new Scanner(file);
        String currentLine;
        String c;
        int j = 0;
    ...
    */
    public void writeReservations(Hotel hotelel, ReservationData data){
        try{
            FileWriter writer = new FileWriter("src/res.csv");
    ...
    */
    public void writeCheckIns(Hotel hotelel, ReservationList checkin){
        try{
            FileWriter writer = new FileWriter("src/checkin.csv");
            writer.write("Reservation Number");
            writer.write(",");
            writer.write("Name");
            writer.write(",");
    ...
    */
    public void writeCheckOuts(Hotel hotelel, ReservationList checkout){
        try{
            FileWriter writer = new FileWriter("src/checkout.csv");
            writer.write("Reservation Number");
            writer.write(",");
            writer.write("Name");
            writer.write(",");
    ...
    */
    public void writeCancellations(Hotel hotelel, ReservationList cancellations){
        try{
            FileWriter writer = new FileWriter("src/cancellations.csv");
            writer.write("Reservation Number");
            writer.write(",");
            writer.write("Name");
            writer.write(",");
